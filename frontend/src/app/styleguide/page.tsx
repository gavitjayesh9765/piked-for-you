...
/**
 * Living style guide. Not shipped to users — this is the surface for reviewing
 * the token system in both themes at once. Flip the theme toggle at the top and
 * every swatch, component and state below re-renders from the same tokens.
 */
