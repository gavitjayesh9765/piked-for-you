...
export default async function AllCategoriesPage() {
  ...
  const chapters = chaptersOf(roots);

  const every = chapters.flatMap(flatten);
            ...
            <div className="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
              <div className="max-w-3xl">
                ...
                <p className="mt-6 max-w-xl text-body-lg text-ink-muted">
                  {every.length} categories, and an honest account of how far we have actually got
                  in each one. We would rather show you the gaps than pretend they are not there.
                </p>
              </div>
